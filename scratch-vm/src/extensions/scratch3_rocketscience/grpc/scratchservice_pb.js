...
proto.Vessel.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    met: +jspb.Message.getFieldWithDefault(msg, 5, 0.0),
    stage: jspb.Message.getFieldWithDefault(msg, 6, 0),
    biome: jspb.Message.getFieldWithDefault(msg, 7, ""),
    recoverable: jspb.Message.getFieldWithDefault(msg, 8, false),
    crewcapacity: jspb.Message.getFieldWithDefault(msg, 9, 0),
    crewcount: jspb.Message.getFieldWithDefault(msg, 10, 0),
    mass: +jspb.Message.getFieldWithDefault(msg, 11, 0.0),
    drymass: +jspb.Message.getFieldWithDefault(msg, 12, 0.0),
    ...
    launchtime: +jspb.Message.getFieldWithDefault(msg, 18, 0.0),
...
proto.Vessel.prototype.clearTargetdirection = function() {
  this.setTargetdirection(undefined);
};
...
proto.Orbit.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    timetoan: +jspb.Message.getFieldWithDefault(msg, 25, 0.0),
    timetodn: +jspb.Message.getFieldWithDefault(msg, 26, 0.0),
    starttransitiontype: jspb.Message.getFieldWithDefault(msg, 27, 0),
    endtransitiontype: jspb.Message.getFieldWithDefault(msg, 28, 0),
    timetosoichange: +jspb.Message.getFieldWithDefault(msg, 29, 0.0)
  };
...
proto.CelestialBody.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    mass: +jspb.Message.getFieldWithDefault(msg, 3, 0.0),
    gravitationalparameter: +jspb.Message.getFieldWithDefault(msg, 4, 0.0),
    surfacegravity: +jspb.Message.getFieldWithDefault(msg, 5, 0.0),
    rotationalperiod: +jspb.Message.getFieldWithDefault(msg, 6, 0.0),
    rotationalspeed: +jspb.Message.getFieldWithDefault(msg, 7, 0.0),
    rotationangle: +jspb.Message.getFieldWithDefault(msg, 8, 0.0),
    initialrotation: +jspb.Message.getFieldWithDefault(msg, 9, 0.0),
    equatorialradius: +jspb.Message.getFieldWithDefault(msg, 10, 0.0),
    sphereofinfluence: +jspb.Message.getFieldWithDefault(msg, 11, 0.0),
    orbit: (f = msg.getOrbit()) && proto.Orbit.toObject(includeInstance, f),
    hasatmosphere: jspb.Message.getFieldWithDefault(msg, 13, false),
    atmospheredepth: +jspb.Message.getFieldWithDefault(msg, 14, 0.0),
    hasatmosphericoxygen: jspb.Message.getFieldWithDefault(msg, 15, false),
    biomesList: jspb.Message.getRepeatedField(msg, 16),
    flyinghighaltitudethreshold: +jspb.Message.getFieldWithDefault(msg, 17, 0.0),
    spacehighaltitudethreshold: +jspb.Message.getFieldWithDefault(msg, 18, 0.0),
...
proto.TargetOrbitInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
    closestapproachtime: +jspb.Message.getFieldWithDefault(msg, 1, 0.0),
    timetoclosestapproach: +jspb.Message.getFieldWithDefault(msg, 2, 0.0),
    closestapproachdistance: +jspb.Message.getFieldWithDefault(msg, 3, 0.0),
    trueanomalyatan: +jspb.Message.getFieldWithDefault(msg, 4, 0.0),
    timetotargetan: +jspb.Message.getFieldWithDefault(msg, 5, 0.0),
    trueanomalyatdn: +jspb.Message.getFieldWithDefault(msg, 6, 0.0),
    timetotargetdn: +jspb.Message.getFieldWithDefault(msg, 7, 0.0),
    relativeinclination: +jspb.Message.getFieldWithDefault(msg, 8, 0.0),
    targetrelativespeed: +jspb.Message.getFieldWithDefault(msg, 9, 0.0),
    targetdistance: +jspb.Message.getFieldWithDefault(msg, 10, 0.0)
  };
...
proto.GetTargetVesselOrbitInfoResponse.prototype.clearTargetorbitinfo = function() {
  this.setTargetorbitinfo(undefined);
};
...
proto.GetTargetDockingPortInfoResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    distance: +jspb.Message.getFieldWithDefault(msg, 7, 0.0),
    relativespeed: +jspb.Message.getFieldWithDefault(msg, 8, 0.0)
  };
...
proto.GetTargetDockingPortInfoResponse.prototype.clearRelativeangles = function() {
  this.setRelativeangles(undefined);
};
...
proto.GetTargetDockingPortInfoResponse.prototype.clearRelativedistance = function() {
  this.setRelativedistance(undefined);
};
...
proto.GetTargetDockingPortInfoResponse.prototype.clearRelativevelocity = function() {
  this.setRelativevelocity(undefined);
};
...
proto.GetVerticalLandingInfoResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    surfacealtitude: +jspb.Message.getFieldWithDefault(msg, 5, 0.0),
    surfaceslope: +jspb.Message.getFieldWithDefault(msg, 6, 0.0)
  };
...
proto.GetReentryInfoResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    surfacealtitude: +jspb.Message.getFieldWithDefault(msg, 1, 0.0),
    airspeed: +jspb.Message.getFieldWithDefault(msg, 2, 0.0),
    mach: +jspb.Message.getFieldWithDefault(msg, 3, 0.0),
    surfacespeed: +jspb.Message.getFieldWithDefault(msg, 4, 0.0),
    terminalspeed: +jspb.Message.getFieldWithDefault(msg, 5, 0.0),
    externaltemperature: +jspb.Message.getFieldWithDefault(msg, 6, 0.0),
    totaltemperature: +jspb.Message.getFieldWithDefault(msg, 7, 0.0),
    statictemperature: +jspb.Message.getFieldWithDefault(msg, 8, 0.0),
    podtemperature: +jspb.Message.getFieldWithDefault(msg, 9, 0.0),
    podskintemperature: +jspb.Message.getFieldWithDefault(msg, 10, 0.0),
    podmaxskintemperature: +jspb.Message.getFieldWithDefault(msg, 11, 0.0),
    shieldtemperature: +jspb.Message.getFieldWithDefault(msg, 12, 0.0),
    shieldskintemperature: +jspb.Message.getFieldWithDefault(msg, 13, 0.0),
    shieldmaxskintemperature: +jspb.Message.getFieldWithDefault(msg, 14, 0.0),
    drag: +jspb.Message.getFieldWithDefault(msg, 15, 0.0),
    dragacc: +jspb.Message.getFieldWithDefault(msg, 16, 0.0),
    ablator: (f = msg.getAblator()) && observor_pb.VesselResource.toObject(includeInstance, f),
    dynamicpressure: +jspb.Message.getFieldWithDefault(msg, 18, 0.0),
    acceleration: (f = msg.getAcceleration()) && observor_pb.Vector3d.toObject(includeInstance, f)
  };
...
proto.GetManeuverNodeInfoResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    utpe: +jspb.Message.getFieldWithDefault(msg, 2, 0.0),
    utap: +jspb.Message.getFieldWithDefault(msg, 3, 0.0),
    utan: +jspb.Message.getFieldWithDefault(msg, 4, 0.0),
    utdn: +jspb.Message.getFieldWithDefault(msg, 5, 0.0),
    uttargetan: +jspb.Message.getFieldWithDefault(msg, 6, 0.0),
    uttargetdn: +jspb.Message.getFieldWithDefault(msg, 7, 0.0),
    uttargetclosestapproach: +jspb.Message.getFieldWithDefault(msg, 8, 0.0),
...
proto.GetRunwayLandingInfoResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    altitude: +jspb.Message.getFieldWithDefault(msg, 1, 0.0),
    distance: +jspb.Message.getFieldWithDefault(msg, 2, 0.0),
    yawoffset: +jspb.Message.getFieldWithDefault(msg, 3, 0.0),
    surfacespeed: +jspb.Message.getFieldWithDefault(msg, 4, 0.0),
    forwarderror: +jspb.Message.getFieldWithDefault(msg, 5, 0.0),
    velocityerror: +jspb.Message.getFieldWithDefault(msg, 6, 0.0),
    pitch: +jspb.Message.getFieldWithDefault(msg, 7, 0.0),
    roll: +jspb.Message.getFieldWithDefault(msg, 8, 0.0),
    verticalspeed: +jspb.Message.getFieldWithDefault(msg, 9, 0.0),
    runwaymeanaltitude: +jspb.Message.getFieldWithDefault(msg, 10, 0.0)
  };
